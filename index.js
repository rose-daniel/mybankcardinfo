...
function bankCardAttribution(bankCard) {
    ...
    /*银行图片*/
    var banks = [
        { bankCode: "ICBC", name: "工商银行", url: "/images/2018/user/banks/icbc.png" },
        { bankCode: "CCB", name: "建设银行", url: "/images/2018/user/banks/cbc.png" },
        { bankCode: "COMM", name: "交通银行", url: "/images/2018/user/banks/bcm.png" },
        { bankCode: "ABC", name: "农业银行", url: "/images/2018/user/banks/abc.png" },
        { bankCode: "CMB", name: "招商银行", url: "/images/2018/user/banks/cmb.png" },
        { bankCode: "CMBC", name: "中国民生银行", url: "/images/2018/user/banks/mb.png" },
        { bankCode: "BOC", name: "中国银行", url: "/images/2018/user/banks/bc.png" }]


    function getBankImg(bankcode) {
        for (var i = 0, num = banks.length; i < num; i++) {
            if (bankcode === banks[i].bankCode) {
                return banks[i].url;
            }
        }
        return "";
        ...
        for (var i = 0, len = bankcardList.length; i < len; i++) {
            ...
            for (var j = 0, jLen = patterns.length; j < jLen; j++) {
                ...
                if ((new RegExp(pattern.reg)).test(cardNo)) {
                    ...
                    info['bankimg'] = getBankImg(info['bankCode']);
                    return info;//返回银行卡结果
                }
            }
        }
